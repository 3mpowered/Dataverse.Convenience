...
namespace Empowered.Dataverse.Model
{
	...
	public partial class Solution : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<Empowered.Dataverse.Model.Solution> Referencedsolution_parent_solution
		{
			get
			{
				return this.GetRelatedEntities<Empowered.Dataverse.Model.Solution>("solution_parent_solution", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<Empowered.Dataverse.Model.Solution>("solution_parent_solution", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<Empowered.Dataverse.Model.SolutionComponent> solution_solutioncomponent
		{
			get
			{
				return this.GetRelatedEntities<Empowered.Dataverse.Model.SolutionComponent>("solution_solutioncomponent", null);
			}
			set
			{
				this.SetRelatedEntities<Empowered.Dataverse.Model.SolutionComponent>("solution_solutioncomponent", null, value);
			}
		}
		...
		public Empowered.Dataverse.Model.SystemUser lk_solution_createdby
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Model.SystemUser>("lk_solution_createdby", null);
			}
		}
		...
		public Empowered.Dataverse.Model.SystemUser lk_solution_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Model.SystemUser>("lk_solution_modifiedby", null);
			}
		}
		...
		public Empowered.Dataverse.Model.SystemUser lk_solutionbase_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Model.SystemUser>("lk_solutionbase_createdonbehalfby", null);
			}
		}
		...
		public Empowered.Dataverse.Model.SystemUser lk_solutionbase_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Model.SystemUser>("lk_solutionbase_modifiedonbehalfby", null);
			}
		}
		...
		public Empowered.Dataverse.Model.Organization organization_solution
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Model.Organization>("organization_solution", null);
			}
		}
		...
		public Empowered.Dataverse.Model.Solution Referencingsolution_parent_solution
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Model.Solution>("solution_parent_solution", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
	}
}
