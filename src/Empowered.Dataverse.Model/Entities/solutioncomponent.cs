...
namespace Empowered.Dataverse.Model
{
	...
	public partial class SolutionComponent : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<Empowered.Dataverse.Model.SolutionComponent> Referencedsolutioncomponent_parent_solutioncomponent
		{
			get
			{
				return this.GetRelatedEntities<Empowered.Dataverse.Model.SolutionComponent>("solutioncomponent_parent_solutioncomponent", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<Empowered.Dataverse.Model.SolutionComponent>("solutioncomponent_parent_solutioncomponent", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public Empowered.Dataverse.Model.SystemUser lk_solutioncomponentbase_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Model.SystemUser>("lk_solutioncomponentbase_createdonbehalfby", null);
			}
		}
		...
		public Empowered.Dataverse.Model.SystemUser lk_solutioncomponentbase_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Model.SystemUser>("lk_solutioncomponentbase_modifiedonbehalfby", null);
			}
		}
		...
		public Empowered.Dataverse.Model.Solution solution_solutioncomponent
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Model.Solution>("solution_solutioncomponent", null);
			}
		}
		...
		public Empowered.Dataverse.Model.SolutionComponent Referencingsolutioncomponent_parent_solutioncomponent
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Model.SolutionComponent>("solutioncomponent_parent_solutioncomponent", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
	}
}
